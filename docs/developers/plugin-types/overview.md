...
- [Dashboard Widgets](dashboard-widgets) - Detailed widget development
- [CLI Plugins](cli-plugins) - Command-line tool creation
- [Background Services](background-services) - Service development guide
- [Hybrid Plugins](hybrid-plugins) - Multi-type plugin development
